                ...
                <div style="width: 1300px" class="collapse navbar-collapse" id="app-navbar-collapse">  <!-- tamaño menu-->
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            <li id="s0"><a href="{{ route('equipments') }}" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Equipments</a></li>
                           ...
                           <!--   <li id="s4"><a href="ldlpipes" style="border-radius: 0px 0px 4px 4px;transition:200ms" onMouseOver="this.style.background='#B0BED9';this.style.color='white'" onMouseOut="this.style.background='white';this.style.color='black'">Line List</a></li> -->
