    ...
    <div class="row">
        ...
        <?php $sum_per_civil = DB::select("SELECT SUM(total_progress) as sum_per_civil FROM pcivils_view"); ?>
                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/civils') }}">
                        {!! csrf_field() !!}
                    
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='{{ url('ecivils') }}'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('areas_id[]', [null => 'Select Area...'] + $areas, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')) !!}
                                    </td>
                                    <td>
                                        {!! Form::select('tcivils_id[]', [null => 'Select Type...'] + $type_civil , null, array('style'=>'height:34px;font-size: 14px;font-weight: normal;','rcivilred')) !!}
                                    </td>
                                    <td>
                                        {!! Form::number('qty[]', null, array('placeholder' => 'Qty','style'=>'width: 75px','class' => 'form-control','min' => '1','rcivilred')) !!}
                                    </td>
                                   <!--  <td>
                                        {!! Form::number('est_qty[]', null, array('placeholder' => 'Qty','class' => 'form-control','style' => 'width: 70px;font-size: 14px;font-weight: normal;','rcivilred')) !!}
                                    </td> -->
                                    <td>
                        ...
                        <input onclick="location.href='{{ url('ecivils') }}'" type="submit" class="btn btn-lg btn-default" style="padding: 8px 16px;font-size: 12px;" data-dismiss="modal" value="Cancel">
