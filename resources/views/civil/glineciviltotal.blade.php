...
@section('content')
  ...
  <script type="text/javascript">
                        function mySubmit() {
                                   var theForm = document.forms['glinecivil'];
                                     if (!theForm) {
                                         theForm = document.glinecivil;
      ...
      <div class="col-md-9" style="left: 12%;margin-top: 4%;" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 4%">
                        ...
                        <center>
                          <form id="glinecivil" class="form-horizontal" role="form" method="POST" action="{{ url('glinecivil') }}">
                        {{ csrf_field() }}
                                                ...
                                                ['Week','Progress','Estimated'],
                                                 ...
                                                 @foreach ($lineestimated as $lineestimatedd)
                                                  ...
                                                  <?php 
                                                   ...
                                                   $hcivils =DB::select("SELECT * FROM hcivils");//validar si existe hcivils para mantener la curva en 0 o en su ultimo valor

                                                  if ((count($hcivils))>0 AND ($i<($lineprogress_count[0]->count))){  
                        ...
                        <button onclick="location.href='{{ url('milestonescivil') }}'" type="button" class="btn btn-primary btn-lg">Milestones</button>
