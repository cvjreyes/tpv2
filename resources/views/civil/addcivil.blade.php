    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr><td class="no">' + n + '</td>' +
                    ...
                    '<td>{!! Form::select('tcivils_id[]', [null => 'Select Area...'] + $tcivils, null, ['required']) !!}</td>'+
...
$(document).ready(function() {
    oTable = $('#ecivil').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "{{ route('civilpment.addcivil') }}",
        "columns": [
            {data: 'area', name: 'area'},
            {data: 'type', name: 'type'},
            {data: 'code', name: 'code'},
    ...
    <div class="modal fade" id="addcivilModal" 
     tabindex="-1" role="dialog" 
     aria-labelledby="addcivilModalLabel">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <br>
                <br>
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/addcivil') }}">
                        {!! csrf_field() !!}
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('tcivils_id[]', [null => 'Select Type...'] + $tcivils, null, ['required']) !!}
                                    </td>
                                    <td>
