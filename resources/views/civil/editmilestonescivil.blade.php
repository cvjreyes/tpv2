...
@else
    ...
    <div class="modal fade" id="editmilestonescivilModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="editmilestonescivilModalLabel">
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexcivil.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/updatemilestonescivil') }}">
