...
@else
    ...
    <div class="modal fade" id="delecivilsModal" style="top:20%;" 
     tabindex="-1" role="dialog" 
     aria-labelledby="delecivilsModalLabel">
   <div class="row">
        <div class="col-md-4 col-md-offset-4">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexcivil.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/delecivil') }}">
             ...
             <!--       <form class="form-horizontal" role="form" method="POST" action="{{ url('/editcivil/') }}"> -->
                        ...
                        <br>
                            ...
                            <tbody style="display:none" class="resultbody">
                           <tr>
                                    <td style="">{!! Form::text('id', null, array('class' => 'id')) !!}</td>
