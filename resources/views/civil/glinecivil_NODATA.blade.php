            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 10%">
                        ...
                        {{ csrf_field() }}
                         ...
                         <?php //$lineprogress=DB::select("SELECT DATE_FORMAT(hcivils.date,'%d-%m-%Y') as date,area,progress FROM hcivils");?> 
                             ...
                             <div id="linechart" class="linechart">
                                    ...
                                    <h3 style='background-color: #FCF8E3'>
                                        The area <?php echo $selected_area[0]->name; ?> does not contain modeled civil!</h3>
                        ...
                        <button onclick="location.href='{{ url('civils') }}'" type="button" class="btn btn-lg btn-default">Estimated</button>
