...
@else
    ...
    <div class="modal fade" id="editcivilModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="editcivilModalLabel">
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexcivil.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/updatecivil') }}">
                        @endforeach
                    ...
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('tcivils_id', [null => 'Select Type...'] + $tcivils , null, array('class' => 'tcivils_id','style'=>'width: 150px;height:34px;font-size: 14px;font-weight: normal;','required')) !!}
                                    </td>
                                    <td>
