...
// SHOW/UPDATE MILESTONES EQUI 
$(document).on('click', '.edit-milestonesequi-modal', function() {
...
@role('EquiAdmin')
<table border id="milestonesequi" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
    <center><thead>
        <tr>
      <!--       <th>Area</th> -->
            <th>Week</th>
...
$(document).ready(function() {
    oTable = $('#milestonesequi').DataTable({
        
        "processing": true,
        "serverSide": false,
        "ajax": "{{ route('equipment.milestones') }}",
        "columns": [
            // {data: 'area', name: 'area'},
            {data: 'week', name: 'week'},
...
@endrole
  @extends('equipment.editmilestonesequi')
...
<script type="text/javascript">
  ...
  <center>
  <button onclick="location.href='{{ url('equipments') }}'" type="button" class="btn btn-primary btn-lg">Estimated</button>
