      ...
      <div class="col-md-9" style="left: 12%;margin-top: 4%;" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 4%">
                        ...
                        <center>
                           <br><br>
                        <button onclick="location.href='{{ url('equis') }}'" type="button" class="btn btn-primary btn-lg">Estimated</button>
                        <button onclick="location.href='{{ url('milestonesequi') }}'" type="button" class="btn btn-primary btn-lg">Milestones</button>
