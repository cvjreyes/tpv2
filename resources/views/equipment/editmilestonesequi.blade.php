...
@else
    ...
    <div class="modal fade" id="editmilestonesequiModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="editmilestonesequiModalLabel">
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexequi.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/updatemilestonesequi') }}">
