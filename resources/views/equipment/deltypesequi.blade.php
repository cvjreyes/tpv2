   ...
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexequi.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/deletetypesequi') }}">
             ...
             <!--       <form class="form-horizontal" role="form" method="POST" action="{{ url('/editequi/') }}"> -->
                        ...
                        <center>
                        <br>
                            <h4 class="modal-title" style='margin: 0 auto; padding-top: 0px; text-align: center; width: 400px;font-size: 20px;font-weight: bold;'>Are you sure you want to delete the following type of equipment?</h4>
                            <br>
