...
<button onclick="location.href='{{ url('exportmodeledequi') }}'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
<br>
...
$(document).ready(function() {
    oTable = $('#modeledequi').DataTable({
        ...
        "serverSide": false,
        "autoWidth": false,
        "ajax": "{{ route('equipment.dequisfullquery') }}",
        "columns": [
            {data: 'unit', name: 'unit'},
            {data: 'area', name: 'area'},
            {data: 'tag', name: 'tag'},
