    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr><td class="no">' + n + '</td>' +
                    ...
                    '<td>{!! Form::select('tinsts_id[]', [null => 'Select Area...'] + $tinsts, null, ['required']) !!}</td>'+
...
<table id="einst" class="table table-hover table-condensed" style="width:100%">
...
$(document).ready(function() {
    ...
    <div class="modal fade" id="addinstModal" 
     ...
     aria-labelledby="addinstModalLabel">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <br>
                <br>
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/addinst') }}">
                        {!! csrf_field() !!}
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('tinsts_id[]', [null => 'Select Type...'] + $tinsts, null, ['required']) !!}
                                    </td>
                                    <td>
