...
// SHOW/UPDATE MILESTONES inst 
$(document).on('click', '.edit-milestonesinst-modal', function() {
...
@role('InstAdmin')
<table border id="milestonesinst" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
    <center><thead>
        <tr>
            <th>Area</th>
            <th>Week</th>
...
$(document).ready(function() {
    oTable = $('#milestonesinst').DataTable({
        
        "processing": true,
        "serverSide": false,
        "ajax": "{{ route('instruments.milestones') }}",
        "columns": [
            {data: 'area', name: 'area'},
            {data: 'week', name: 'week'},
...
@endrole
  @extends('instruments.editmilestonesinst')
