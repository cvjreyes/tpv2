...
@else
 <div class="modal fade" id="createtypesinstModal";
     tabindex="-1" role="dialog" data-backdrop="static" 
     aria-labelledby="createtypesinstModalLabel">
    <div class="row">
        ...
        <?php $sum_per_inst = DB::select("SELECT SUM(total_progress) as sum_per_inst FROM pinsts_view"); ?>
                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/typesinst') }}">
                        {!! csrf_field() !!}
                    
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='{{ url('typesinst') }}'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
                    ...
                    <table class="table table-striped">
                        ...
                        <input onclick="location.href='{{ url('typesinst') }}'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" value="Cancel">
