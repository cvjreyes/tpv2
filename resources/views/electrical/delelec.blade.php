...
@else
    ...
    <div class="modal fade" id="deleelecsModal" style="top:20%;" 
     tabindex="-1" role="dialog" 
     aria-labelledby="deleelecsModalLabel">
   <div class="row">
        <div class="col-md-4 col-md-offset-4">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexelec.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/deleelec') }}">
