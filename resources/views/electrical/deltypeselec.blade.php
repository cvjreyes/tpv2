...
@else
    ...
    <div class="modal fade" id="deltypeselecModal" style="top:20%;" 
     tabindex="-1" role="dialog" 
     aria-labelledby="deltypeselecModalLabel">
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexelec.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/deletetypeselec') }}">
             ...
             <!--       <form class="form-horizontal" role="form" method="POST" action="{{ url('/editelec/') }}"> -->
                        ...
                        <center>
                        <br>
                            <h4 class="modal-title" style='margin: 0 auto; padding-top: 0px; text-align: center; width: 400px;font-size: 20px;font-weight: bold;'>Are you sure you want to delete the following type of elec?</h4>
                            <br>
