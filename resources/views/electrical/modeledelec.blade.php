...
<button onclick="location.href='{{ url('exportmodeledelec') }}'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
<br>
...
<br>
  ...
  <button onclick="location.href='{{ url('elecpments') }}'" type="button" class="btn btn-lg btn-default">Estimated</button>
