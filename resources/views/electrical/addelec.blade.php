    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr><td class="no">' + n + '</td>' +
                    ...
                    '<td>{!! Form::select('telecs_id[]', [null => 'Select Area...'] + $telecs, null, ['required']) !!}</td>'+
...
<table id="eelec" class="table table-hover table-condensed" style="width:100%">
...
$(document).ready(function() {
    ...
    <div class="modal fade" id="addelecModal" 
     tabindex="-1" role="dialog" 
     aria-labelledby="addelecModalLabel">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <br>
                <br>
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/addelec') }}">
                        {!! csrf_field() !!}
                    <table class="table table-striped">
                            ...
                            <tbody class="resultbody">
                                <tr>
                                    ...
                                    <td>
                                        {!! Form::select('telecs_id[]', [null => 'Select Type...'] + $telecs, null, ['required']) !!}
                                    </td>
                                    <td>
