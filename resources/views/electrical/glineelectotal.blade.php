      ...
      <div class="col-md-9" style="left: 12%;margin-top: 4%;" >
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="margin-top: 4%">
                                                ...
                                                ['Week','Progress','Estimated'],
                                                 ...
                                                 @foreach ($lineestimated as $lineestimatedd)
                                                  ...
                                                  <?php 
                                                   ...
                                                   $helecs =DB::select("SELECT * FROM helecs");//validar si existe helecs para mantener la curva en 0 o en su ultimo valor

                                                  if ((count($helecs))>0 AND ($i<($lineprogress_count[0]->count))){  
                        ...
                        <button onclick="location.href='{{ url('milestoneselec') }}'" type="button" class="btn btn-primary btn-lg">Milestones</button>
