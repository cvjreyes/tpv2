...
@else
    ...
    <div class="modal fade" id="editmilestoneselecModal" style="top:20%"; 
     tabindex="-1" role="dialog" 
     aria-labelledby="editmilestoneselecModalLabel">
   <div class="row">
        <div class="col-md-5 col-md-offset-3">
         ...
         <!--           Form::model($item, ['method' => 'PATCH','route' => ['indexelec.update', $item->id]]) -->
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/updatemilestoneselec') }}">
