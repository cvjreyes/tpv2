 ...
 <div class="modal fade" id="createelecModal";
    ...
    <div class="row">
        ...
        <?php $sum_per_elec = DB::select("SELECT SUM(total_progress) as sum_per_elec FROM pelecs_view"); ?>
                ...
                <div class="panel-body">
                   ...
                   <form class="form-horizontal" role="form" method="POST" action="{{ url('/milestoneelec') }}">
                        {!! csrf_field() !!}
                    
                        <div class="modal-header" style="background-color: #F5F8FA;border-radius: 4px;">
                            <button onclick="location.href='{{ url('milestoneelec') }}'" type="button" class="close" data-dismiss="modal"" aria-label="Close">
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/js/bootstrap-datepicker.js"></script>
                    ...
                    <table class="table table-striped">
                        ...
                        <input onclick="location.href='{{ url('milestoneelec') }}'" type="submit" class="btn btn-lg btn-default" data-dismiss="modal" value="Cancel">
