...
// SHOW/UPDATE elec 
$(document).on('click', '.edit-typeselec-modal', function() {
...
// DESTROY elec 
$(document).on('click', '.del-typeselec-modal', function() {
...
<div class="container">
    ...
    <center>
        ...
        <h2><b>Electrical Types</b></h2>
        <h3><?php echo env('APP_NAMEPROJ') ?></h3>

    </center>

@role('ElecAdmin')<button style="align:right" type="button" class="btn btn-lg btn-default" data-toggle="modal" data-target="#createtypeselecModal"><img src="{{ asset('images/add-icon.ico') }}" style="width:23px" ></button>&nbsp;@endrole
<button onclick="location.href='{{ url('exporttypeelec') }}'" type="button" class="btn btn-lg btn-success" style="font-size: 16px;font-weight: bold">Excel</button><br>
...
@role('ElecAdmin')
<table border id="typeelec" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
    <center><thead>
        <tr>
            <th>Code</th>
            <th>Name</th>
...
$(document).ready(function() {
    oTable = $('#typeelec').DataTable({
        
        "processing": true,
        "serverSide": false,
        "ajax": "{{ route('electrical.types') }}",
        "columns": [
            {data: 'code', name: 'code'},
            {data: 'name', name: 'name'},
...
@endrole
@extends('electrical.createtypeselec')

  @extends('electrical.edittypeselec')
  @extends('electrical.deltypeselec')
<br>
<br>
<br>
...
<script type="text/javascript">
  ...
  <button onclick="location.href='{{ url('glineelec') }}'" type="button" class="btn btn-primary btn-lg">Curve</button>
