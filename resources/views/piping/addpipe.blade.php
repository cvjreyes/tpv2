    ...
    $(function () {
        $('.add').click(function () {
            ...
            var tr = '<tr class="fila">' +
                    ...
                    '<td>{!! Form::select('tpipes_id[]', [null => 'Select Type...'] + $tpipes, null, array( 'style'=>'height:34px;font-size: 14px;font-weight: normal;','required')) !!}</td>'+
                    '<td>{!! Form::number('qty[]', null, array('placeholder' => 'Qty','class' => 'form-control','style' => 'width: 70px;font-size: 14px;font-weight: normal;','required')) !!}</td>'+
