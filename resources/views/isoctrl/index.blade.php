...
$(document).on('click', '.edit-hisoctrls-modal', function() {
...
<div class="container">
    ...
    <center>
        ...
        <td>
             <button onclick="location.href='{{ url('isostatus') }}'" type="button" class="btn btn-info btn-lg" style="width:25%"><b>Status</b>
                </button>
             <button onclick="location.href='{{ url('hisoctrl') }}'" type="button" class="btn btn-primary btn-lg" style="width:25%"><b>History</b>
                </button>
...
<table border id="hisoctrls" class="table table-hover table-condensed" style="width: 100%;font-size: 14px;font-weight: normal;white-space: nowrap">
...
$(document).ready(function() {
    oTable = $('#hisoctrls').DataTable({
        
        "processing": true,
        "serverSide": false,
        "ajax": "{{ route('isoctrl.index') }}",
        "order": [[ 1, "desc" ]],
        "pageLength" : 8,
        "columns": [
