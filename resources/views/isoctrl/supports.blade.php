...
$(document).on('click', '.show-vcomments-modal', function() {
    ...
    <tr>
        ...
        $bfile= "../public/storage/isoctrl/supports/attach/".$afilename[0].".bfile";
        $dxf= "../public/storage/isoctrl/supports/attach/".$afilename[0].".dxf";
      ...
      <td>
          ...
          <a class="upload-design-modal btn btn-xs btn-info" data-filename ="<?php echo $filename[$i]; ?>" data-pathfrom="supports"  data-requestbydesign="<?php echo $requested[0]->requested; ?>" data-requestbylead ="<?php echo $requested[0]->requestedlead; ?>" data-toggle="modal" data-target="#uploadfromdesignModal">Upload File</a>
      ...
      <button class="btn btn-sm btn-success" name="destination" value="materials">Send to Materials</button>
