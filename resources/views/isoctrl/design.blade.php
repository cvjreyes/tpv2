  ...
  <div class="row">
    ...
    <form id="frm-example" class="form-horizontal" role="form" method="POST" action="{{ url('/sendfromdesignbulk') }}">    
      ...
      <table style='width: 100%'> 
        <td>      
        <button onclick="location.href='{{ url('isostatus') }}'" type="button" class="btn btn-info btn-lg" style="width:23%"><b>Status</b>
        </button>
         <button onclick="location.href='{{ url('hisoctrl') }}'" type="button" class="btn btn-info btn-lg" style="width:23%"><b>History</b>
        </button>
        <?php if (auth()->user()->hasRole('DesignAdmin')){ ?> 
        <button onclick="location.href='{{ url('file') }}'" type="button" class="btn btn-info btn-lg" style="width:23%"><b>Upload Isofiles</b>
        </button><?php }?>
        <?php if (auth()->user()->hasRole('DesignAdmin')){ ?> 
